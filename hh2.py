...
def _pip_install(pkg):
    # Su dung '-U' de dam bao goi duoc cap nhat
...
# Cai dat optuna-integration[lightgbm]
try:
    from optuna.integration import LightGBMPruningCallback
except Exception as e:
    # Neu gap loi import, tien hanh cai dat
...
def add_kwh_lags_rollings(df, lags=(1,2,3,7,14,21,28), windows=(7,14,30)):
    ...
    # Day la phan sua loi syntax khoang trang
    for W in windows:
        past = df["kWh"].shift(1)
